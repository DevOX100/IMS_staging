...
public partial class AddUser : System.Web.UI.Page
{
 ...
 // Billing_System bs = new Billing_System();
    ...
    Inventory_System newUser = new Inventory_System();
 // Billing_System newUser = new Billing_System();
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                ddlRoleID.DataSource = ISS.SelectRoleForAdmin();
            }
            else
            {
                ddlRoleID.DataSource = ISS.SelectRole();
            }
    ...
    protected void CreateUserButton_Click(object sender, EventArgs e)
    {
        ...
        ds = newUser.CreateUserLogin(UserName, UserCode, Password, BCode, RoleID, Email, Mobile, RCode,Dpmt, loginType);
    ...
    {
        ISS.UserCode = txtEmpCode.Text.Trim();
        ds = ISS.SelectUniqueUser();
    ...
    protected void txtMobile_TextChanged(object sender, EventArgs e)
    {
        ...
        ds = ISS.CheckExistingMobileData(Mobile);
        if (ds.Tables[0].Rows.Count > 0)
        {
    ...
    protected void txtEmail_TextChanged(object sender, EventArgs e)
    {
        ...
        ds = ISS.CheckExistingEmailData(Email);
        if (ds.Tables[0].Rows.Count > 0)
        {
    ...
    {
        string RCode = ddlRegion.SelectedValue;
        ds = ISS.GetBranchDetailsbyRCode(RCode);
    ...
    {
        ds = ISS.GetDepartmentListByUser(Session["UserCode"].ToString());
